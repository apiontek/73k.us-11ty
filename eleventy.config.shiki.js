...
const caddyfileLangGrammar = JSON.parse(
  readFileSync("./syntax-langs/vscode-caddyfile/syntaxes/caddyfile.tmLanguage.json", "utf8")
)
const caddyfileLang = {
  id: "caddyfile",
...
const nunjucksLangGrammar = plist2js(
  readFileSync("./syntax-langs/vscode-nunjucks/syntaxes/nunjucks.tmLanguage", "utf8").toString()
)
const nunjucksLang = {
  id: "nunjucks",
